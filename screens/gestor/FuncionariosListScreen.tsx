...
const FuncionariosListScreen = () => {
  ...
  // Fetch all employees using the hook generated by Orval
  const { data: funcionariosResponse, isLoading: isLoadingFuncionarios, error: funcionariosError, refetch } = useFuncionarioControllerFindAll({
    query: {
      enabled: !isLoadingUserCheck, // Only run query after user check is complete
    }
  });

  // Assuming the API returns { data: Funcionario[] }
  const funcionarios = funcionariosResponse?.data || [];

  // Handle API errors
  useEffect(() => {
    if (funcionariosError) {
      console.error('Error fetching employees:', funcionariosError);
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              <View style={styles.itemDetails}>
                ...
                {/* Add more details if needed, e.g., salary */}
                {/* <Text style={styles.itemDetailText}>
