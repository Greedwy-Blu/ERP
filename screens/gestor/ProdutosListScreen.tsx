...
import { useProdutoControllerFindAll } from '@/api/generated'; // Adjust path if needed
...
const ProdutosListScreen = () => {
  ...
  const { data: produtosResponse, isLoading: isLoadingProdutos, error: produtosError, refetch } = useProdutoControllerFindAll({
    query: {
      enabled: !isLoadingUserCheck, // Only run query after user check is complete
    }
  });

  // Assuming the API returns { data: Produto[] }
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => router.push('/(home)/ProdutoCreateScreen')} // Adjust route as needed
        >
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() => router.push({ pathname: '/(home)/ProdutoDetailScreen', params: { produtoId: item.id }})}
            >
